...
configs_path=${PROJECT_NAME}/selftests/bpf/configs
DENYLIST=$(read_lists "$configs_path/denylist/DENYLIST-${KERNEL}" "$configs_path/denylist/DENYLIST-${KERNEL}.${ARCH}")
ALLOWLIST=$(read_lists "$configs_path/allowlist/ALLOWLIST-${KERNEL}" "$configs_path/allowlist/ALLOWLIST-${KERNEL}.${ARCH}")
